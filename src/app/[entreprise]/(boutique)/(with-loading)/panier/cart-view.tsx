...
import { createCompanyCheckoutSession } from "@/server/company-checkout";

export function CompanyCartView({ entreprise }: { entreprise: string }) {
  ...
  const items = allItems.filter((item) => item.companySlug === entreprise);
