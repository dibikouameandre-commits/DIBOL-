...
import { getCompanyOrderDetail } from "@/server/company-admin/orders";
import { CompanyOrderStatusSelect } from "../order-status-select";

export const metadata: Metadata = { title: "Détail commande — Admin entreprise" };
...
export default async function CompanyOrderDetailPage({
  ...
  const order = await getCompanyOrderDetail(entreprise, id);
