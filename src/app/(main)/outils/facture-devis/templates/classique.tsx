...
const meta = getFactureTemplateMeta("classique");

export function ClassiqueFactureHtmlPreview({ data }: { data: FactureResultData }) {
    ...
    <div className="bg-white text-neutral-900" style={rootStyle}>
      ...
      >
        <div className="max-w-[60%]">
          ...
          <h2 className="text-lg font-bold">{form.issuerName || "Nom de l'entreprise"}</h2>
          {form.issuerAddress && (
        ...
        <div className="shrink-0 text-right">
          <span
            className="inline-block rounded px-3.5 py-1.5 text-sm font-bold tracking-wide text-white"
      ...
      <div
        ...
        style={{ marginBottom: 20 * scale.sectionGapMultiplier }}
      />
      ...
      <div className="overflow-hidden rounded-sm">
        <div
          className="flex gap-3 rounded-sm px-2.5 text-[10px] font-bold tracking-wide uppercase"
          style={{ backgroundColor: meta.accentSoft, paddingTop: 8 * scale.rowPaddingMultiplier, paddingBottom: 8 * scale.rowPaddingMultiplier }}
        >
      ...
      >
        ...
        <div
          className="mt-1 flex justify-between rounded-sm px-2.5 py-2 text-sm font-bold text-white"
          style={{ backgroundColor: meta.accent }}
        >
          <span>Total</span>
