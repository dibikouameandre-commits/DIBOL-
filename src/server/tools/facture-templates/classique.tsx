...
const styles = StyleSheet.create({
  ...
  logo: { width: 52, height: 52, marginBottom: 8, objectFit: "contain" },
  issuerName: { fontSize: 15, fontFamily: "Helvetica-Bold", marginBottom: 4 },
  issuerLine: { fontSize: 9, color: "#555555", lineHeight: 1.4 },
  docBadge: {
    alignSelf: "flex-end",
  ...
  docMetaLabel: { fontSize: 9, color: "#777777" },
  docMetaValue: { fontSize: 9, fontFamily: "Helvetica-Bold" },
  divider: { borderBottom: "1 solid #E2E2E2", marginBottom: 20 },
...
export function ClassiqueFactureDocument({ data }: { data: FactureResultData }) {
    ...
    <Document>
      ...
      >
        <View style={[styles.headerRow, { marginBottom: 24 * scale.sectionGapMultiplier }]}>
          ...
          <View>
            <Text style={styles.docBadge}>{docLabel}</Text>
